...
def main():
    ...
    parser.add_argument("--port", type=int, default=50053, help="Service port override.")
    ...
    with grpc.insecure_channel(address) as channel:
        result = run_embedding(channel, payload, pb2_grpc.ItmoPersonificationLargeGrpcServiceStub)
