...
#### **Особенности задачи**
Чтобы работать со звуком современные аудиоLLM (**SALMONN** [4], **Qwen2-Audio** [5]) используют специальные энкодеры, которые преобразуют аудио в векторные представления. Часто для этой цели выбирают Whisper, так как это открытая легкая модель, зарекомендовавшая себя в речевых задачах. Но модели, обученные с учителем (supervized), в том числе и Whisper, часто страдают от переобучения и не способны обобщать свои возможности на различные аудио-сценарии: эмоциональная речь, шумы, разные условия записи и т.д. 
