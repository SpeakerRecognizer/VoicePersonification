...
#### **Особенности задачи**
В отличие от текста, аудио имеет непрерывную структуру. Чтобы работать со звуком современные аудиоLLM (**SALMONN** [4] и **Qwen2-Audio** [5]) используют специальные энкодеры, которые преобразуют аудио в векторные представления. Часто для этой цели выбирают Whisper, так как это открытая легкая модель, и ее векторные представления зарекомендовали себя в различных речевых задачах. Но важно держать в голове, что звук это не только слова, произносимые человеком, но и много другое: интонации, неречевые звуки, искажения сигнала и т.д. Чтобы работать в таких разнообразных условиях, Whisper'a, обученного в supervized-режиме может быть недостаточно. Supervized модели часто страдают от переобучения и не способны обобщать свои возможности на различные аудио-сценарии.
...
1.  **Аудио-энкодер:** За восприятие аудио в модели отвечает **WavLM** [2]. В отличие от моделей вроде Whisper, обученных в supervized-режиме, WavLM обучалась в манере self-supervised на огромном массиве аудиоданных. Как показывает практика, это дает  ей более универсальное представление о звуках любого типа.
